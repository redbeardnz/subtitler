...
|${\color{#F0F8FF}aliceblue}$ 'F0F8FF'|${\color{#FAEBD7}antiquewhite}$ 'FAEBD7'|${\color{#00FFFF}aqua}$ '00FFFF'|${\color{#7FFFD4}aquamarine}$ '7FFFD4'|${\color{#F0FFFF}azure}$ 'F0FFFF'|${\color{#F5F5DC}beige}$ 'F5F5DC'|${\color{#FFE4C4}bisque}$ 'FFE4C4'|
|--|--|--|--|--|--|--|
|${\color{#000000}black}$ '000000'|${\color{#FFEBCD}blanchedalmond}$ 'FFEBCD'|${\color{#0000FF}blue}$ '0000FF'|${\color{#8A2BE2}blueviolet}$ '8A2BE2'|${\color{#A52A2A}brown}$ 'A52A2A'|${\color{#DEB887}burlywood}$ 'DEB887'|${\color{#5F9EA0}cadetblue}$ '5F9EA0'|
|--|--|--|--|--|--|--|
|${\color{#7FFF00}chartreuse}$ '7FFF00'|${\color{#D2691E}chocolate}$ 'D2691E'|${\color{#FF7F50}coral}$ 'FF7F50'|${\color{#6495ED}cornflowerblue}$ '6495ED'|${\color{#FFF8DC}cornsilk}$ 'FFF8DC'|${\color{#DC143C}crimson}$ 'DC143C'|${\color{#00FFFF}cyan}$ '00FFFF'|
|--|--|--|--|--|--|--|
|${\color{#00008B}darkblue}$ '00008B'|${\color{#008B8B}darkcyan}$ '008B8B'|${\color{#B8860B}darkgoldenrod}$ 'B8860B'|${\color{#A9A9A9}darkgray}$ 'A9A9A9'|${\color{#006400}darkgreen}$ '006400'|${\color{#A9A9A9}darkgrey}$ 'A9A9A9'|${\color{#BDB76B}darkkhaki}$ 'BDB76B'|
|--|--|--|--|--|--|--|
|${\color{#8B008B}darkmagenta}$ '8B008B'|${\color{#556B2F}darkolivegreen}$ '556B2F'|${\color{#FF8C00}darkorange}$ 'FF8C00'|${\color{#9932CC}darkorchid}$ '9932CC'|${\color{#8B0000}darkred}$ '8B0000'|${\color{#E9967A}darksalmon}$ 'E9967A'|${\color{#8FBC8F}darkseagreen}$ '8FBC8F'|
|--|--|--|--|--|--|--|
|${\color{#483D8B}darkslateblue}$ '483D8B'|${\color{#2F4F4F}darkslategray}$ '2F4F4F'|${\color{#2F4F4F}darkslategrey}$ '2F4F4F'|${\color{#00CED1}darkturquoise}$ '00CED1'|${\color{#9400D3}darkviolet}$ '9400D3'|${\color{#FF1493}deeppink}$ 'FF1493'|${\color{#00BFFF}deepskyblue}$ '00BFFF'|
|--|--|--|--|--|--|--|
|${\color{#696969}dimgray}$ '696969'|${\color{#696969}dimgrey}$ '696969'|${\color{#1E90FF}dodgerblue}$ '1E90FF'|${\color{#B22222}firebrick}$ 'B22222'|${\color{#FFFAF0}floralwhite}$ 'FFFAF0'|${\color{#228B22}forestgreen}$ '228B22'|${\color{#FF00FF}fuchsia}$ 'FF00FF'|
|--|--|--|--|--|--|--|
|${\color{#DCDCDC}gainsboro}$ 'DCDCDC'|${\color{#F8F8FF}ghostwhite}$ 'F8F8FF'|${\color{#FFD700}gold}$ 'FFD700'|${\color{#DAA520}goldenrod}$ 'DAA520'|${\color{#808080}gray}$ '808080'|${\color{#008000}green}$ '008000'|${\color{#ADFF2F}greenyellow}$ 'ADFF2F'|
|--|--|--|--|--|--|--|
|${\color{#808080}grey}$ '808080'|${\color{#F0FFF0}honeydew}$ 'F0FFF0'|${\color{#FF69B4}hotpink}$ 'FF69B4'|${\color{#CD5C5C}indianred}$ 'CD5C5C'|${\color{#4B0082}indigo}$ '4B0082'|${\color{#FFFFF0}ivory}$ 'FFFFF0'|${\color{#F0E68C}khaki}$ 'F0E68C'|
|--|--|--|--|--|--|--|
|${\color{#E6E6FA}lavender}$ 'E6E6FA'|${\color{#FFF0F5}lavenderblush}$ 'FFF0F5'|${\color{#7CFC00}lawngreen}$ '7CFC00'|${\color{#FFFACD}lemonchiffon}$ 'FFFACD'|${\color{#ADD8E6}lightblue}$ 'ADD8E6'|${\color{#F08080}lightcoral}$ 'F08080'|${\color{#E0FFFF}lightcyan}$ 'E0FFFF'|
|--|--|--|--|--|--|--|
|${\color{#FAFAD2}lightgoldenrodyellow}$ 'FAFAD2'|${\color{#D3D3D3}lightgray}$ 'D3D3D3'|${\color{#90EE90}lightgreen}$ '90EE90'|${\color{#D3D3D3}lightgrey}$ 'D3D3D3'|${\color{#FFB6C1}lightpink}$ 'FFB6C1'|${\color{#FFA07A}lightsalmon}$ 'FFA07A'|${\color{#20B2AA}lightseagreen}$ '20B2AA'|
|--|--|--|--|--|--|--|
|${\color{#87CEFA}lightskyblue}$ '87CEFA'|${\color{#778899}lightslategray}$ '778899'|${\color{#778899}lightslategrey}$ '778899'|${\color{#B0C4DE}lightsteelblue}$ 'B0C4DE'|${\color{#FFFFE0}lightyellow}$ 'FFFFE0'|${\color{#00FF00}lime}$ '00FF00'|${\color{#32CD32}limegreen}$ '32CD32'|
|--|--|--|--|--|--|--|
|${\color{#FAF0E6}linen}$ 'FAF0E6'|${\color{#FF00FF}magenta}$ 'FF00FF'|${\color{#800000}maroon}$ '800000'|${\color{#66CDAA}mediumaquamarine}$ '66CDAA'|${\color{#0000CD}mediumblue}$ '0000CD'|${\color{#BA55D3}mediumorchid}$ 'BA55D3'|${\color{#9370DB}mediumpurple}$ '9370DB'|
|--|--|--|--|--|--|--|
|${\color{#3CB371}mediumseagreen}$ '3CB371'|${\color{#7B68EE}mediumslateblue}$ '7B68EE'|${\color{#00FA9A}mediumspringgreen}$ '00FA9A'|${\color{#48D1CC}mediumturquoise}$ '48D1CC'|${\color{#C71585}mediumvioletred}$ 'C71585'|${\color{#191970}midnightblue}$ '191970'|${\color{#F5FFFA}mintcream}$ 'F5FFFA'|
|--|--|--|--|--|--|--|
|${\color{#FFE4E1}mistyrose}$ 'FFE4E1'|${\color{#FFE4B5}moccasin}$ 'FFE4B5'|${\color{#FFDEAD}navajowhite}$ 'FFDEAD'|${\color{#000080}navy}$ '000080'|${\color{#FDF5E6}oldlace}$ 'FDF5E6'|${\color{#808000}olive}$ '808000'|${\color{#6B8E23}olivedrab}$ '6B8E23'|
|--|--|--|--|--|--|--|
|${\color{#FFA500}orange}$ 'FFA500'|${\color{#FF4500}orangered}$ 'FF4500'|${\color{#DA70D6}orchid}$ 'DA70D6'|${\color{#EEE8AA}palegoldenrod}$ 'EEE8AA'|${\color{#98FB98}palegreen}$ '98FB98'|${\color{#AFEEEE}paleturquoise}$ 'AFEEEE'|${\color{#DB7093}palevioletred}$ 'DB7093'|
|--|--|--|--|--|--|--|
|${\color{#FFEFD5}papayawhip}$ 'FFEFD5'|${\color{#FFDAB9}peachpuff}$ 'FFDAB9'|${\color{#CD853F}peru}$ 'CD853F'|${\color{#FFC0CB}pink}$ 'FFC0CB'|${\color{#DDA0DD}plum}$ 'DDA0DD'|${\color{#B0E0E6}powderblue}$ 'B0E0E6'|${\color{#800080}purple}$ '800080'|
|--|--|--|--|--|--|--|
|${\color{#663399}rebeccapurple}$ '663399'|${\color{#FF0000}red}$ 'FF0000'|${\color{#BC8F8F}rosybrown}$ 'BC8F8F'|${\color{#4169E1}royalblue}$ '4169E1'|${\color{#8B4513}saddlebrown}$ '8B4513'|${\color{#FA8072}salmon}$ 'FA8072'|${\color{#F4A460}sandybrown}$ 'F4A460'|
|--|--|--|--|--|--|--|
|${\color{#2E8B57}seagreen}$ '2E8B57'|${\color{#FFF5EE}seashell}$ 'FFF5EE'|${\color{#A0522D}sienna}$ 'A0522D'|${\color{#C0C0C0}silver}$ 'C0C0C0'|${\color{#87CEEB}skyblue}$ '87CEEB'|${\color{#6A5ACD}slateblue}$ '6A5ACD'|${\color{#708090}slategray}$ '708090'|
|--|--|--|--|--|--|--|
|${\color{#708090}slategrey}$ '708090'|${\color{#FFFAFA}snow}$ 'FFFAFA'|${\color{#00FF7F}springgreen}$ '00FF7F'|${\color{#4682B4}steelblue}$ '4682B4'|${\color{#D2B48C}tan}$ 'D2B48C'|${\color{#008080}teal}$ '008080'|${\color{#D8BFD8}thistle}$ 'D8BFD8'|
|--|--|--|--|--|--|--|
|${\color{#FF6347}tomato}$ 'FF6347'|${\color{#40E0D0}turquoise}$ '40E0D0'|${\color{#EE82EE}violet}$ 'EE82EE'|${\color{#F5DEB3}wheat}$ 'F5DEB3'|${\color{#FFFFFF}white}$ 'FFFFFF'|${\color{#F5F5F5}whitesmoke}$ 'F5F5F5'|${\color{#FFFF00}yellow}$ 'FFFF00'|
|--|--|--|--|--|--|--|
